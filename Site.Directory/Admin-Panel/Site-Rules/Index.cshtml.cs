...
namespace RoleplayersGuild.Site.Directory.Admin_Panel.Site_Rules
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            PageContent = await _dataService.GetScalarAsync<string>("""SELECT "RulesPageContent" FROM "GeneralSettings" """) ?? "";
            return Page();
        }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            // Corrected: SQL query uses PascalCase
            await _dataService.ExecuteAsync("""UPDATE "GeneralSettings" SET "RulesPageContent" = @Content""", new { Content = PageContent });
